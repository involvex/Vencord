...
function noopTracerWithResults<F extends Func>(
    name: string,
    f: F,
...
function noopTracer<F extends Func>(
    name: string,
    f: F,
    mapper?: TraceNameMapper<F>,
) {
...
export const traceFunctionWithResults = !(IS_DEV || IS_REPORTER)
    ...
    : function traceFunctionWithResults<F extends Func>(
          name: string,
          f: F,
          mapper?: TraceNameMapper<F>,
      ): (this: unknown, ...args: Parameters<F>) => [ReturnType<F>, number] {
