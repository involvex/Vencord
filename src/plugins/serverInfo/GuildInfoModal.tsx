...
const FriendRow = findComponentByCodeLazy(
    "discriminatorClass:",
    ".isMobileOnline",
    "getAvatarURL",
);
    ...
    return (
        <div className={cl("root")}>
            ...
            >
                ...
                <TabBar.Item
                    className={cl("tab", {
                        selected: currentTab === Tabs.IgnoredUsers,
                    })}
            ...
            <div className={cl("tab-content")}>
                ...
                {currentTab === Tabs.IgnoredUsers && (
                    <IgnoredUserTab guild={guild} setCount={setIgnoredCount} />
                )}
            </div>
        </div>
    );
