...
export default definePlugin({
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: m =>
                        `${m}$self.isHiddenChannel(arguments[0]?.channel)?true:`,
                },
                {
            ...
            replacement: [
                {
                    ...
                    replace:
                        "(arguments[0]?.inCall||!$self.isHiddenChannel(arguments[0]?.channel,true))&&$&",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace:
                        "!$self.isHiddenChannel(arguments[0]?.channel,true)&&$&",
                },
            ],
        },
        {
    ...
    isHiddenChannel(
        ...
        try {
            if (
                channel == null ||
                (Object.hasOwn(channel, "channelId") &&
