    ...
    children.splice(
        ...
        <Menu.MenuGroup>
            <Menu.MenuItem
                ...
                label="View Avatar"
                action={() =>
                    openAvatar(IconUtils.getUserAvatarURL(user, true))
                }
                icon={ImageIcon}
            />
            {memberAvatar && (
    ...
    patches: [
            ...
            replacement: [
                {
                    ...
                    replace:
                        '$&style:{cursor:"pointer"},onClick:()=>{$self.openAvatar($1)},',
                },
            ],
            all: true,
        },
        // Banners
        {
            ...
            replacement: {
                ...
                replace: (_, rest, bannerSrc) =>
                    `${rest},onClick:()=>${bannerSrc}!=null&&$self.openBanner(${bannerSrc}),style:{cursor:${bannerSrc}!=null?"pointer":void 0,`,
            },
        },
        // Group DMs top small & large icon
        {
            ...
            replacement: {
                ...
                replace: (m, iconUrl) =>
                    `${m},onClick:()=>arguments[0]?.size!=="SIZE_48"&&$self.openAvatar(${iconUrl})`,
            },
        },
        // User DMs top small icon
        {
            ...
            replacement: {
                ...
                replace: (_, avatarUrl) =>
                    `,onClick:()=>$self.openAvatar(${avatarUrl})`,
            },
        },
