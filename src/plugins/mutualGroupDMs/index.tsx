    ...
    return mutualDms.map(c => (
        ...
        >
            ...
            <div className={MutualsListClasses.details}>
                <div className={MutualsListClasses.name}>
                    {getGroupDMName(c)}
                </div>
...
export default definePlugin({
            ...
            replacement: [
                {
                    ...
                    replace:
                        "$&||$self.getMutualGroupDms(arguments[0].user.id).length>0",
                },
                {
    ...
    getMutualGroupDms(userId: string) {
        try {
            ...
            new Logger("MutualGroupDMs").error(
                "Failed to get mutual group dms:",
                e,
            );
        }
    ...
    pushSection(sections: any[], user: User) {
        try {
            ...
            new Logger("MutualGroupDMs").error(
                "Failed to push mutual group dms section:",
                e,
            );
        }
    },
