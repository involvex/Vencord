...
const PlatformIcon = ({
    ...
    return (
        <Icon
            color={useStatusFillColor(status)}
            tooltip={tooltip}
            small={small}
        />
    );
...
const PlatformIndicator = ({
    ...
    const status = useStateFromStores(
        [PresenceStore],
        () =>
            PresenceStore.getClientStatus(user.id) as Record<Platform, string>,
    );
...
const indicatorLocations = {
    list: {
        ...
        onEnable: () =>
            addMemberListDecorator("platform-indicator", ({ user }) =>
                user && !user.bot ? (
                    <PlatformIndicator user={user} small={true} />
                ) : null,
            ),
    ...
    messages: {
        ...
        onEnable: () =>
            addMessageDecoration("platform-indicator", props => {
